...
# Compute sub-satellite points and print the first 10
subsatellite_points = []
for t in times:
...
# Print the first 10 sub-satellite points for debugging
print("First 10 sub-satellite points:")
for i, (lat, lon) in enumerate(subsatellite_points[:10]):
    print(f"{i+1}. Latitude: {lat:.2f}, Longitude: {lon:.2f}")
